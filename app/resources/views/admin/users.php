                ...
                <tbody>
                 ...
                 <tr>
                    ...
                    <td>
                      ...
                      <a data-uri="<?=BASE_URI?>admin/users/delete/<?=e($user->id)?>" class="btn btn-danger btn-sm btn-delete" data-toggle="tooltip" data-placement="top" title="" data-original-title="Delete"><i class="fa fa-trash fa-fw"></i></a>
                    </td>
                  </tr>
                 <?php endforeach?>
                </tbody>
